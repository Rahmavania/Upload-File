    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?= round(filesize($currentDir . "/" . $file) / 1024, 2) ?> KB</td>
                <td>
                    <a href="<?= $currentDir . "/" . $file ?>" class="btn btn-sm btn-success" download>⬇️ Unduh</a>
                    <form method="POST" style="display:inline;">
                        <input type="hidden" name="delete_name" value="<?= $file ?>">
